...
class WU_OpenSRS_Settings {
	...
	private function __construct() {
		...
		add_action( 'load-' . 'network_page_wu-reseller-manager', array( $this, 'handle_settings_save' ) );
		add_action( 'load-' . 'network_page_wu-reseller-manager-opensrs', array( $this, 'handle_opensrs_save' ) );
		add_action( 'load-' . 'network_page_wu-reseller-manager-namecheap', array( $this, 'handle_namecheap_save' ) );
		add_action( 'load-' . 'network_page_wu-reseller-manager-default', array( $this, 'handle_default_provider_save' ) );
	}
	...
	public function register_admin_pages() {
		...
		// The parent menu slug should be the Ultimate Multisite main menu
		$parent = 'wp-ultimo';
